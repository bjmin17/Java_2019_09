...
public class BankExec_04 {
	...
	public static void main(String[] args) {
		...
		BankServiceV1 bs = null; // new BankServiceV1(); V1에 파라메터있는 생성자 만들면서 null로 바꿔줌
		...
		while(true) {
			 ...
			 * Java에서는
			 * switch(문자열, 숫자, 문자...) 가능
			 * 하지만 문자열일 경우 약간의 문제 발생 가능성 존재
			 * (아래 label(레이블)을 못찾는 경우 존재)
			 */
			switch (intMenu) {
			case 1: // label, GOTO명령을 사용할 때 쓰는 키워드
