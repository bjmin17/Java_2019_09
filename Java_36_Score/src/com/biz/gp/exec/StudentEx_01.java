...
public class StudentEx_01 {
	...
	public static void main(String[] args) {
		...
		// List에 추가 -- (주의) 매개변수의 순서를 반드시 알고 있어야 한다는 점
		stdList.add(new StudentVO("004", "임꺽정", "010-333", "남원시", 3, "005"));		
		stdList.add(new StudentVO("005", "임꺽정", "010-333", "남원시", 3, "005"));
		stdList.add(new StudentVO("006", "임꺽정", "010-333", "남원시", 3, "005"));
		stdList.add(new StudentVO("007", "임꺽정", "010-333", "남원시", 3, "005"));
		stdList.add(new StudentVO("008", "임꺽정", "010-333", "남원시", 3, "005"));
		stdList.add(new StudentVO("009", "임꺽정", "010-333", "남원시", 3, "005"));
