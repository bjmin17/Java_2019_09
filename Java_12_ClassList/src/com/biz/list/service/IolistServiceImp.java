...
public class IolistServiceImp {
	...
	public void input() {
		...
		iolistVO = new IolistVO("2019-09-05", "14:00:02", "CJ햇반", 1500);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05", "14:00:03", "CJ햇반", 1500);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05", "14:00:04", "CJ햇반", 1500);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05", "14:00:05", "CJ햇반", 1500);
		iolist.add(iolistVO);
	} // input() end
