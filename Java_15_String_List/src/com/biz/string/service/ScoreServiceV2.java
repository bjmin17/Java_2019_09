 ...
 * 성적 정보를 출력하면서
 * 학번 정보를 기준으로
 * 학생 정보(이름)를 같이 보여주는 list() method를 재정의하자.
 * 
 * ==================================
...
public class ScoreServiceV2 extends ScoreServiceV1 {
	...
	// 없을 경우 : package scope, 같은 package내에서는 public 처럼 동작으로하고
	//							다른 package에서는 private처럼 동작을 한다.
	
	// java 패턴에서는
	// 특별한 경우가 아니면
	// 멤버변수들은 private이나 protected 로 설정하도록
	// 권장한다.
	...
	public void list() {
		...
		// ScoreServiceV1에서 protected 상태로 상속받았기 때문에
		// 접근하여 값을 읽을 수 있다.
	...
	// main() method에서 StudentService로부터
	// 		stdList를 getter 하여
	//		setStdList() 메서드를 통해
	// 		ScoreService에 주입한다.
