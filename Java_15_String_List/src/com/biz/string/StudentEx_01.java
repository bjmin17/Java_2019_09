...
public class StudentEx_01 {
	...
	public static void main(String[] args) {
		...
		// stService를 잠시 StudentServiceV1 인 것 처럼
		// 바꾸는 것
		
		// 우항의 값을 StudentVO에 담음
		StudentVO stdVO = ((StudentServiceV1)stService).search("00003");
		
		// search() method를 호출하면서 학번 00001을 매개변수로
		// 전달하였고
		
		// 만약 해당 학번의 데이터가 있으면
		// stdVO에는 학생 정보가 담겨 있을 것이다.
		...
		if(stdVO == null) {
			...
			System.out.println(stdVO.toString());// toString을 호출해서 그 내용을 보여줘라
		}
