...
public class NullValue {
	...
	public static void main(String[] args) {
		...
		// 이 때, 선언되는 변수를 primitive(기본형) 변수라고 한다.
		// 기본형 변수를 clear할 때는
		...
		int[] nums = null;// 참조형으로 변함
		
		// 변수선언 키워드 첫 글자가 대문자로 시작되는 선언문
		// 이 때, 선언되는 변수를 type형(참조형, reference형)
		//		변수 라고 한다.
		// type형 변수를 clear 할 때는
		...
		StudentVO studentVO = null; // clear,,, null은 String형 이외에 다양한 곳에서 초기화 가능
