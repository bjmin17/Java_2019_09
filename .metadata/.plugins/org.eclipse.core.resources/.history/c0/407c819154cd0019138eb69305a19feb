...
public class MethodService {
	 ...
	 * method를 정의할 때
	 * (method 코드를 작성할 때)
	 * void method() : void 키워드가 붙은 method로 return 문이 있거나 없거나
	 * 변수를 선언하는 키워드 method()
	 * 		int method()
	 * 		String method()
	 * 		float method()
	 ...
	 * 		return type 이라고 한다.
	 * 		이 때, 이 키워드는 return 문에 포함된 값과
	 * 		밀접한 관계가 있다.
	 * void method 제외하고 나머진 return type method라고 한다.
	 *
	 * 		int method() { return 0;}
	...
	// 없어도 된다!!
	public void consoleView() { //void라고 앞에 있으면 return문이 있어도 되고 없어도 되고
		System.out.println("나는 콘솔에 표시하는 method()");
		return ; //비어있으면 return;이라는 코드가 들어있음.(consoleView라는 메서드가 끝났다는 의미.)
	}
	
	// return num; 문에서
	// num 변수의 data type이 int형이다.
	// 따라서 이 method의 선언문에는 int 키워드가 포함되어야 한다.
	...
	// method의 return 문에 intSum 변수가 포함되어 있다.
