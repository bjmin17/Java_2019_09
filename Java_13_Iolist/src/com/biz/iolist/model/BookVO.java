...
public class BookVO {
	...
	public String getStrWrtier() {
		return strWrtier;
	}
	public void setStrWrtier(String strWrtier) {
		this.strWrtier = strWrtier;
	}
